  ...
  return (
    <div className="grid gap-y-9">
      <div className="grid gap-y-2 xl:gap-y-5">
        <p className="text-[18px] md:text-[20px] font-travel-bold text-center text-[#F7ECE1]">Borrow Amount</p>
        {/* Supply Amount */}
          ...
          <div className="grid gap-y-4">
            <div className="flex justify-between px-2 py-3 md:px-3 md:py-4 xl:px-6 xl:py-4 border-b border-[#f7ece180]">
              ...
              <div className="text-[12px] md:text-[14px] text-right">
                <p className="opacity-50">Borrow Limit</p>
      ...
      <div className="grid gap-y-5 text-[#F7ECE1]">
        <p className="text-[18px] md:text-[20px] font-travel-bold text-center">Borrow Stats</p>
        <div className="text-[16px] md:text-[20px] grid gap-y-4">
          <div className="flex justify-between">
            <p className="opacity-50">Borrow APY</p>
            <p>2.88%</p>
          </div>
          <div className="flex justify-between">
            <p className="opacity-50">Borrow Balance</p>
            <p>$0.0</p>
          </div>
        </div>
      </div>
